...
const app=initializeApp(firebaseConfig),db=getFirestore(app),auth=getAuth(app),provider=new GoogleAuthProvider(),$=id=>document.getElementById(id);const ADMINS=["028riu@gmail.com","tu0ngtun2gsahur8@gmail.com","linh085760@gmail.com","phuong026443@stu.vinschool.edu.vn","
minh037199@stu.vinschool.edu.vn","
tran034866@stu.vinschool.edu.vn"].map(x=>x.toLowerCase());const DAY=86400000,TZ="Asia/Ho_Chi_Minh";let users=[],homeworks=[],subjects=[],progressDocs=[],settings={};let unsub=[];let selected=new Set(),month=new Date();let sort="activity";
